            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="col-auto float-right ml-auto">
                        ...
                        <a href="{{ route('category.index') }}" class="btn add-btn btn-primary" style="background-color: #1a2eb9; border: 1px solid #1a2eb9;color: #fff; margin-right: 7px;" ><i class="fa fa-excel"></i> Back</a>
                    </div>
                    <ul class="breadcrumb">
