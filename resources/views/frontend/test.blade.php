            ...
            <div class="container">
                ...
                <div class="site-filters clearfix center m-b40">
                    <ul class="filters" data-toggle="buttons">
                        ...
                        <li data-filter="designing" class="btn"><input type="radio"><a href="javascript:void(0);" class="site-button outline outline-2 button-sm btn-tb"><span>Designing</span></a></li>
                        <li data-filter="programming" class="btn"><input type="radio"><a href="javascript:void(0);" class="site-button outline outline-2 button-sm btn-tb"><span>Programming</span></a></li>
                        <li data-filter="officepackage" class="btn"><input type="radio"><a href="javascript:void(0);" class="site-button outline outline-2 button-sm btn-tb"><span>Office Package</span></a>
                        </li>
                        <li data-filter="corporate" class="btn"><input type="radio"><a href="javascript:void(0);" class="site-button outline outline-2 button-sm btn-tb"><span>Corporate</span></a></li>
                        <li data-filter="other" class="btn"><input type="radio"><a href="javascript:void(0);" class="site-button outline outline-2 button-sm btn-tb"><span>Others</span></a></li>
                    </ul>
                </div>
                <div class="clearfix" id="lightgallery">
                    <ul id="masonry" class="portfolio-ic dlab-gallery-listing row gallery-grid-4 lightgallery">
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 other">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.pditcourse')}}"><img src="{{ asset('images/course/pdit-course.jpeg') }}" style="width:334px; height:160px;" alt="" lazy="loading"></a>
                                    <div class="user-info">
                                        <a href="{{route('course.pditcourse')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.pditcourse')}}" style="color: black;">PDIT</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                                        <span class="price">12 Months</span>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 other">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.aditcourse')}}"><img src="{{ asset('images/course/adit-training.jpeg') }}" style="width:334px; height:160px;" alt="" lazy="loading"></a>
                                    <div class="user-info">
                                        <a href="{{route('course.aditcourse')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.aditcourse')}}" style="color: black;">ADIT</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 other">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.pddptraining')}}"><img src="{{ asset('images/course/pddp-training.jpeg') }}" style="width:334px; height:160px;" alt="" lazy="loading"></a>
                                    <div class="user-info">
                                        <a href="{{route('course.pddptraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.pddptraining')}}" style="color: black;">PDDP</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                                        <span class="price">2 Months</span>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 programming">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.phplaravel')}}"> <img src="{{ asset('images/course/php-laravel.jpg') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.phplaravel')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.phplaravel')}}" style="color: black;">PHP/Laravel</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 programming">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.androidtraining')}}"> <img src="{{ asset('images/course/android-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.androidtraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.androidtraining')}}" style="color: black;">Android Training</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                                        <span class="price">2.5 Months</span>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 programming">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.ccplustraining')}}"> <img src="{{ asset('images/course/c-cpp.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.ccplustraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.ccplustraining')}}" style="color: black;">C/C++ PROGRAMMING</a>
                                    </h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 programming">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.pythontraining')}}"> <img src="{{ asset('images/course/python-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="#">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                ...
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="#" style="color: black;">Python Training</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 designing">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.graphicdesigntraining')}}"> <img src="{{ asset('images/course/graphic-design-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="#">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                ...
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="#" style="color: black;">Graphic Design
                                            Training</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 designing">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.webdesigntraining')}}"> <img src="{{ asset('images/course/web-design-training.jpg') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.webdesigntraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.webdesigntraining')}}" style="color: black;">Web Design Training</a>
                                    </h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 designing">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.videoeditingtraining')}}"> <img src="{{ asset('images/course/video-animation-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.videoeditingtraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="#" style="color: black;">Video
                                            Editing</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 other">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.digitalmarketingtraining')}}"> <img src="{{ asset('images/course/digital-marketing-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.digitalmarketingtraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.digitalmarketingtraining')}}" style="color: black;">Digital Marketing
                                            Training</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 officepackage corporate">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.officetraining')}}"> <img src="{{ asset('images/course/ms-office-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.officetraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.officetraining')}}" style="color: black;">Office Package
                                            Training</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 corporate">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.accountingtraining')}}"> <img src="{{ asset('images/course/accounting-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.accountingtraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.accountingtraining')}}" style="color: black;">Accounting Training</a>
                                    </h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 corporate">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="#"> <img src="{{ asset('images/course/autocad-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="#">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                ...
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="#" style="color: black;">Autocad Training</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 programming">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="#"> <img src="{{ asset('images/course/java-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="#">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                ...
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="#" style="color: black;">Java Training</a></h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                                        </ul>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 designing">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.wordpresstraining')}}"> <img src="{{ asset('images/course/wordpress-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.wordpresstraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.wordpresstraining')}}" style="color: black;">WordPress Training</a>
                                    </h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                        ...
                        <li class="card-container col-lg-3 col-md-6 col-sm-6 other">
                            <div class="dlab-box courses-bx">
                                <div class="dlab-media">
                                    <a href="{{route('course.tallytraining')}}"> <img src="{{ asset('images/course/tally-training.png') }}" alt="" lazy="loading"> </a>
                                    <div class="user-info">
                                        <a href="{{route('course.tallytraining')}}">
                                            <h6 class="title">LEARN MORE</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="dlab-info">
                                    <h6 class="dlab-title"><a href="{{route('course.tallytraining')}}" style="color: black;">Tally Training</a>
                                    </h6>
                                    <div class="courses-info">
                                        <ul>
                                            <li><i class="fa fa-history"></i> Duration: </li>
                            ...
                            <div class="dlab-info p-a20">
                                <div class="dlab-post-meta">
                                    <ul>
                                        ...
                                        <li class="post-tag"> <a href="javascript:void(0);">Notice</a> </li>
                                    </ul>
                                </div>
