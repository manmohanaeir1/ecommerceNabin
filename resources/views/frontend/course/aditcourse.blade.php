			...
			<div class="row">
				<div class="col-lg-12 m-b30">
					<div class="course-view text-center">
						<h2 class="m-t0 m-b10 font-28 title text-black">Advance Diploma in Information Technology Training</h2>
							...
							<div class="course-details dlab-tabs border-top bg-tabs">
								...
								<div class="tab-content">
									<div id="description" class="tab-pane active">
										...
										<p>Anyone can apply the adit entrance form and a student must pass in the entrance.</p>
										<div class="m-t10">
											<h5>Share :</h5>
									...
									<div id="curriculum" class="tab-pane">
										...
										<a href="{{asset('files/adit-syllabus.pdf')}}" class="site-button red m-r15 circle box-shadow" type="button" download=""><i class="fa fa-cloud-download"></i></a>
										<table class="table">
											<thead>
												<tr>
													<th>Lecture</th>
										...
										<h5 class="text-primary">Module 3 Hardware, Maintenance & Troubleshooting</h5>
										<table class="table">
											<thead>
												<tr>
													<th>Lecture</th>
										...
										<h5 class="text-primary">Module 4 Computer Network</h5>
										<table class="table">
											<thead>
												<tr>
													<th>Lecture</th>
										...
										<h5 class="text-primary">Module 5 Web Design and Development</h5>
										<table class="table">
											<thead>
												<th>Lecture</th>
												<th>Unit</th>
										...
										<h5 class="text-primary">Module 6 Cyber Security & Relevant Legislations and Institutions</h5>
										<table class="table">
											<thead>
												<th>Lecture</th>
												<th>Unit</th>
										...
										<h5 class="text-primary">Module 7 Graphic Designing</h5>
										<table class="table">
											<thead>
												</tbody>
										</table>
										...
										<h5 class="text-primary">Module 8 Social Media Marketing</h5>
										<table class="table">
											<thead>
												<tr>
													<th>Lecture</th>
										...
										<h5 class="text-primary">Module 9 Personality Development</h5>
										<table class="table">
