							...
							<ul class="list-category">
								...
								<li class="category-item has-child-cate">
									...
									<ul class="sub-cate">	
										...
										<li class="category-item"><a href="#" class="cate-link">{{$item->name}}</a></li>
										@endforeach									 --}}
									</ul>
								</li>
								@endforeach
							...
							<ul class="products">
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											<a href="{{route('frontend.single-product', $item->id) }}" class="product-name"><span>{!!Str::limit($item->title, 55) !!}</span></a>
											<div class="wrap-price"><span class="product-price">{{$item->price}}</span></div>
										</div>
									</div>
								</li>
