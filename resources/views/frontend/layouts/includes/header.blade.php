				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							{{-- <a href="{{(route('frontend.home'))}}" class="link-to-home"><img src="{{asset('assets/images/logo-top-1')}}" alt="mercado"></a> --}}
							<a href="{{(route('frontend.home'))}}" class="link-to-home"><h3>My Ecommerce</h3> </a>
						</div>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{route('frontend.contact')}}" class="link-term mercado-item-title">Contact Us</a>
								</li>																	
							</ul>
						</div>
					</div>
